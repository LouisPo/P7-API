...
public class BookControllerTest {
    ...
    void checkSaveABook() throws Exception {
        ...
        BookSlimWithLibraryAndStockDto bookDto = new BookSlimWithLibraryAndStockDto(1,"Blackwater, tome 1 : La Digue","Michael McDowell","MONSIEUR TOUSSAINT LOUVERTURE","Fantastique","summary",2,"Louis Nord",nearestDateOfReturn,0,4);
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(
                                "{\"id\":1,\"title\":\"Blackwater, tome 1 : La Digue\",\"author\":\"Michael McDowell\",\"publisher\":\"MONSIEUR TOUSSAINT LOUVERTURE\",\"type\":\"Fantastique\",\"summary\":\"summary\","
                                        + "\"numberOfCopiesAvailable\":2,\"libraryName\":\"Louis Nord\",\"nearestReturnDate\":1656799200000,\"numberOfReservation"
