...
public class LibraryControllerTest {
    ...
    void checkSaveALibrary_shouldReturnAIsCreatedStatus() throws Exception {
        ...
        LibraryDto libraryDto = new LibraryDto(1, "LouisNord@gmail.com", "3 rue des fleurs 57000 Louis", "LouisNord@gmail.com", "0388997744", "10-18h");
        ...
        actualPerformResult.andExpect(MockMvcResultMatchers.status().isCreated())
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(
                                "{\"id\":1,\"name\":\"LouisNord@gmail.com\",\"address\":\"3 rue des fleurs 57000 Louis\",\"email\":\"LouisNord@gmail.com\",\"phone\":\"0388997744\",\"openingTime\":\"10-18h\"}"));
