...
public class LibraryServiceTest  {
    ...
    public void checkSaveALibrary_WhenLibraryIsValid_shouldCallLibraryRepository() throws Exception {
        //GIVEN WHEN
         Library libraryUnderTest = new Library(1,"Louis Nord","3 rue des Fleurs 57000 Louis","Louis@gmail.com","0388779988","10h-18h",null);
    ...
    public void checkDeleteALibrary_shouldCallLibraryRepository() throws Exception {
        ...
        Library libraryUnderTest = new Library(1,"Louis Nord","3 rue des Fleurs 57000 Louis","Louis@gmail.com","0388779988","10h-18h",books);
        //GIVEN WHEN
