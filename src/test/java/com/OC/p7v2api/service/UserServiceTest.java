...
public class UserServiceTest {
    ...
    public void checkSaveAUser_WhenUserIsValid_shouldCallUserRepository() throws Exception {
        //GIVEN WHEN
        User userUnderTest = new User(1,"paul@gmail.com","Paul","Atreid","3 rue des fleurs Louis","0666445599","123",role,null,null);
    ...
    public void checkLoadUserByUserName_whenGivenAValidUsername_shouldReturnAUser() throws Exception {
        ...
        User userUnderTest = new User(1,"paul@gmail.com","Paul","Atreid","3 rue des fleurs Louis","0666445599","123",role,borrows,reservations);
